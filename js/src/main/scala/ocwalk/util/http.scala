...
object http extends Logging {
  ...
  def get[A](path: String, parameters: List[(String, Any)] = Nil)(implicit config: OcwalkConfig, aformat: BF[A]): Future[A] = {
  ...
  def post[A, B](path: String, body: A)(implicit config: OcwalkConfig, aformat: BF[A], bformat: BF[B]): Future[B] = {
  ...
  def postUnit[A](path: String, body: A)(implicit config: OcwalkConfig, aformat: BF[A]): Future[Unit] = {
  ...
  def redirect(path: String)(implicit config: OcwalkConfig): Unit = {
  ...
  def request[A, B](method: String, path: String, parameters: List[(String, Any)], body: Option[A], response: Boolean, api: Boolean)(implicit config: OcwalkConfig, aformat: BF[A], bformat: BF[B]): Future[B] = {
